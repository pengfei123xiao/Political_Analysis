...
class CumulativeAnalysis(threading.Thread):
    ...
    """
    def __init__(self, start_date, end_date, f_tools, find_ip_address, pol_tweets_df, politician_df):
        """
        """
    ...
    def run(self):
        ...
        mentionState_from_mongo = self.f_tools.find_mongo_by_date('backup', 'totalMentionedWithState', datetime(2019, 4, 13), self.end_date, self.find_ip_address)
        ...
        for i in range((self.end_date-self.start_date).days-1):
            ...
            new_pol_tweets_df = self.pol_tweets_df[self.pol_tweets_df['Date'] < end]
            ...
            self.f_tools.save_data(result_dict, 'test', 'sumTest', 'insert_one')
