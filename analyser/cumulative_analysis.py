...
if __name__ == '__main__':
    ...
    date_list = pd.date_range(start='2019-04-15', end='2019-05-16', freq='D')  # , tz='Australia/Sydney')
    # result_dict = {}
    # pol_result = []
    # party_result = []
    for i in range(len(date_list) - 1):
        ...
        gc.collect()
        # pol_result = {'sumPolitician': extend_politician_df.to_dict('records')}
        ...
        # party_result = {'sumParty': sum_party_df.to_dict('records')}
    ...
    # f_tools.drop_collection('test', 'sum')
    # f_tools.save_data(result_dict, 'test', 'sumHead', 'insert_one')
